...
public class RoleService {
     ...
     */
    @CacheEvict(value = "roles", allEntries = true)
    public RoleResponse updateRole(UUID roleUuid, RoleRequest request) {
     ...
     */
    @CacheEvict(value = "roles", allEntries = true)
    public void deleteRole(UUID roleUuid) {
    ...
    public RoleResponse getRole(UUID roleUuid) {
    ...
    public List<RoleResponse> getRolesByOrganization(String organizationUuid) {
    ...
    public List<RoleResponse> getSystemManagedRoles() {
    ...
    public Optional<RoleResponse> getRoleByNameAndOrganization(String roleName, String organizationUuid) {
