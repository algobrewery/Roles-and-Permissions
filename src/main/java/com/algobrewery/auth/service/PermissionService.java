...
/**
 * Service class for permission checking operations.
 */
@Service
public class PermissionService {
    ...
    public PermissionCheckResponse checkPermissionByEndpoint(PermissionCheckRequest request) {
        ...
        return checkPermission(mappedRequest);
    }
